...
int main ()
{
    ...
    UEAA::SharedPointer <UEAA::Enrollee> enrollee1 (new UEAA::Enrollee (UEAA::CStringToHash ("XX0000000")));
    UEAA::SharedPointer <UEAA::Enrollee> enrollee2 (new UEAA::Enrollee (UEAA::CStringToHash ("YY1111111")));
